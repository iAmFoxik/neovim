...
opt.clipboard = { "unnamed", "unnamedplus" } -- Используем системный буфер обмена
...
opt.virtualedit = "block" -- в режиме "block" позволяет размещать курсор за пределами реального текста при блочном выделении
